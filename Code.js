...
function getMasterData() {
  const ss = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1TLTD-Ql90UE155ujIpLQ8WlXJXZ6c1xK7sm5a-qaw60/edit");
...
/* Optional existing function preserved (unchanged).
   If you use it, it's available. */

function sendReportAndMoveDataApu(){
  const SS_ID = '1TLTD-Ql90UE155ujIpLQ8WlXJXZ6c1xK7sm5a-qaw60';
  const MAIL_SHEET = 'MAIL';
  const DB_SHEET = 'DATABASE';
  const DB_CUM_SHEET = 'DB_CUMMULATIVE';
  const EMAIL_TO = 'skumar.wed@delphitvs.com,shp.fpd@delphitvs.com,vasan.ped@delphitvs.com';
  ...
  const subject = `APUWISE MANPOWER PLAN Vs ACTUAL – ${timestamp}`;
  ...
  let htmlBody = `
    <p><b>APUWISE MANPOWER PLAN Vs ACTUAL</b></p>
...
function sendReportAndMoveDataService() {
  const SS_ID = '1TLTD-Ql90UE155ujIpLQ8WlXJXZ6c1xK7sm5a-qaw60';
  const MAIL_SHEET = 'service Mail';
  const DB_SHEET = 'DATABASE';
  const DB_CUM_SHEET = 'DB_CUMMULATIVE';
  const EMAIL_TO = 'skumar.wed@delphitvs.com,shp.fpd@delphitvs.com,vasan.ped@delphitvs.com';
  const NO_REPLY = 'noreply@delphitvs.com';
  ...
  const subject = `SERVICE DEPT Manpower PLAN Vs ACTUAL – ${timestamp}`;
  ...
  let htmlBody = `
    <p><b>SERVICE DEPT Manpower PLAN Vs ACTUAL</b></p>
    <table border="1" cellpadding="6" cellspacing="0" style="border-collapse:collapse;">
  `;
